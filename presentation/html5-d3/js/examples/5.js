...
chart.push(function(div, data){
  ...
  var maxs = data.map(function(d){
  	...
  	return d.close.price+d.close2.price+d.close3.price;
  	 ...
  	 // 	previousValue = typeof previousValue==="object"? previousValue[key].price:previousValue
  	 // 	return previousValue+currentValue[key].price
  	 // });
   });
...
// Number 2
  ...
  function click() {
    ...
    //y.domain([values[i].date, values[j].date]);
